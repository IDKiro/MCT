...
parser.add_argument('--result_dir', type=str, default='./results/mct/')
...
if __name__ == '__main__':
    ...
    netG_A2B.load_state_dict(torch.load(
        os.path.join(args.save_dir, args.task, 'MCT_G_A2B_{}.pth'.format(args.epoch))))
    netG_B2A.load_state_dict(torch.load(
        os.path.join(args.save_dir, args.task, 'MCT_G_B2A_{}.pth'.format(args.epoch))))
